...
// public static final DemonetizedAndIssueDateParser instance = new
// DemonetizedAndIssueDateParser();
...
// private Mono<NumistaPage> parseDemonetizedAndIssueDate(NumistaPage
// numistaPage) {
...
// "value");
// String dayIssueDate =
// NumistaParseUtils.getAttribute(numistaPage.page.selectFirst("input[name=day_issue_date]"),
// "value");
...
// demonetized = "1";
// demonetizationYear =
// NumistaParseUtils.getAttribute(numistaPage.page.selectFirst("#ad"), "value");
// demonetizationMonth =
// NumistaParseUtils.getAttribute(numistaPage.page.selectFirst("#md"), "value");
// demonetizationDay =
// NumistaParseUtils.getAttribute(numistaPage.page.selectFirst("#jd"), "value");
// }
...
// return getNTypeService().update(numistaPage.nType,
// numistaPage.colligendisUserM).flatMap(
// result -> result.fold(
// err -> {
// return Mono.just(numistaPage);
// },
